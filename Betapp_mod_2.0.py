...
class Guy():
    def __init__(self, bettorname, betnum, dognum, cash):
...
class BetApp():
    def __init__(self,master):
        ...
        self.B1 = Guy(0,0,0,50)
        self.B2 = Guy(0,0,0,50)
        self.B3 = Guy(0,0,0,50)
        self.Guys_dict = {}
    ...
    def select(self):
        ...
        cash_list = ['cash1', 'cash2', 'cash3']
        self.Cash = {}        

        for i, bettor in enumerate(self.Bettors, 1):                                  
            self.Guys_dict[self.Gclass_list[i-1]] = Guy(bettor, True, True, True)#reading 
            self.Cash[cash_list[i-1]] = self.Gclass_list[i-1].cash
